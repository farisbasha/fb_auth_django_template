...
from apps.drf_registration.auth import MultiFieldsModelBackend
...
from apps.drf_registration.utils import socials
from apps.drf_registration.exceptions import (
    NotActivated,
    LoginFailed,
    InvalidProvider,
    MissingEmail,
...
class LoginSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        user = MultiFieldsModelBackend.authenticate(self,**data)
        if user:
