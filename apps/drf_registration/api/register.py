...
from apps.drf_registration.tokens import activation_token
...
from apps.drf_registration.utils.email import send_verify_email, send_email_welcome
from apps.drf_registration.utils.users import (
