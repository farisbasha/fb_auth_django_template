...
from apps.drf_registration import api
...
urlpatterns = [
    ...
    path('users/', api.OtherUserListAPIView.as_view() , name='user_list'),
    path('users/<int:pk>/', api.OtherUserProfileUpdateView.as_view(), name='user_detail'),
]
