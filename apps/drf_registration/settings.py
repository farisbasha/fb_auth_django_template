...
from apps.drf_registration.utils.common import generate_settings, get_django_settings

PACKAGE_NAME = 'apps.drf_registration'
...
DEFAULT_SETTINGS = {
    ...
    'RESET_PASSWORD_SUCCESS_TEMPLATE': '<h1>Success</h1><p>Your password has been reset successfully</p>',
